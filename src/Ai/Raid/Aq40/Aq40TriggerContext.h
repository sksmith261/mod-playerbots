...
public:
    RaidAq40TriggerContext()
    {
        ...
        creators["aq40 twins marks"] = &RaidAq40TriggerContext::twins_marks;
...
private:
    ...
    static Trigger* twins_marks(PlayerbotAI* ai) { return new Aq40TwinsMarkTrigger(ai); }
    ...
    static Trigger* ouro_taunt(PlayerbotAI* ai)
    { return new RaidBackupTauntTrigger(ai, "aq40 ouro backup taunt", "ouro"); }
